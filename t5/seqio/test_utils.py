...
def inject_data(task, per_split_data):
  """Inject `per_split_data` into `task`.

  This function takes `per_split_data`, wraps it in a FunctionDataSource,
...
def test_preprocessing(task, raw_data):
...
def test_postprocessing(
  ...
  evaluator = evaluation.Evaluator(task, feature_converter=feature_encoder)
